...
#define PORT_MRF_RESET GPIOB
#define PIN_MRF_RESET GPIO_Pin_10

#define PORT_MRF_CHIPSELECT GPIOB
#define PIN_MRF_CHIPSELECT GPIO_Pin_12
...
extern uint8_t SPI_write(uint8_t cData);
